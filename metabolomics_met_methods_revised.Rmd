...
ggsave('march2018_fig2B.pdf',plot_final, height = 3, width = 4, units = "in", useDingbats = F)
...
p = ggplot(df, aes(x = dilution, y = new_value, color = media)) +
  ...
  xlab('Dilution factor (in media)') + custom_theme4 #+
...
ggsave('March202018_S1.pdf',plot_final, height = 3, width = 6.875, units = "in")
